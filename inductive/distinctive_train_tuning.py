...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_dir', type=str, default='results/WN18RR_v2')
    ...
    ray.init()
    results = tune.run(objective, config=search_space, resources_per_trial={"GPU": 2/4, "CPU": 40/4}, num_samples=40)

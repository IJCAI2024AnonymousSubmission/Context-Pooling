...
from models import Distinct_RED_GNN_trans
...
class DistinctiveModel(BaseModel):
    def __init__(self, args, loader):
        self.model = Distinct_RED_GNN_trans(args, loader)
        self.model.cuda()
    ...
    def evaluate(self, ):
        ...
        out_str = '[VALID] MRR:%.4f H@1:%.4f H@10:%.4f\t [TEST] MRR:%.4f H@1:%.4f H@10:%.4f \t[TIME] train:%.4f inference:%.4f\n' % (
        v_mrr, v_h1, v_h10, t_mrr, t_h1, t_h10, self.t_time, i_time)
        return v_mrr, out_str,t_mrr, t_h1, t_h10
    ...
    def train_batch(self, ):
        ...
        v_mrr, out_str, t_mrr, t_h1, t_h10 = self.evaluate()
        self.loader.shuffle_train()
        return v_mrr, out_str, t_mrr, t_h1, t_h10